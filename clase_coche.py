class Coche:
    ...
    - combustible (int): El nivel de combustible del coche (por defecto: 100).
    - nivel_aceite (int): El nivel de aceite del coche (por defecto: 100).
    - kilometraje (int): El kilometraje del coche (por defecto: 0).
    - encendido (bool): Indica si el coche está encendido o apagado (por defecto: False).

    Métodos:
    - arrancar(): Enciende el coche si hay suficiente combustible y aceite.
    - apagar(): Apaga el coche.
    - acelerar(): Acelera el coche si está encendido y hay suficiente combustible.
    - frenar(): Frena el coche.
    - chequeo_combustible(): Muestra el nivel de combustible del coche.
    - chequeo_nivel_aceite(): Muestra el nivel de aceite del coche.
    - kilometraje(): Devuelve el kilometraje actual del coche.
    - kilometraje(valor): Actualiza el kilometraje del coche.
    - mensaje(): Método de clase que muestra un mensaje de la clase Coche.
    - estado_combustible(nivel): Método estático que devuelve el estado del combustible según el nivel.
